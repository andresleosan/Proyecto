          ...
          <div className="w-80 border-r border-slate-200 bg-white flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              {filteredConversations.length === 0 ? (
                <div className="text-center text-slate-500 py-12">
                  <p className="text-sm">
                    {searchTerm ? 'No coinciden resultados' : 'No hay conversaciones aún'}
                  </p>
                </div>
              ) : (
            ...
            <div className="border-t border-slate-200 p-4 bg-blue-50">
              ...
              <ul className="space-y-2 text-xs text-blue-900">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-blue-500 mt-0.5">•</span>
                  <span>Credenciales de Twilio configuradas en variables de entorno</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-500 mt-0.5">•</span>
                  <span>Servidor de backend desplegado para recibir mensajes</span>
                </li>
              </ul>
            </div>
          </div>
              ...
              {selectedConversation ? (
                <>
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-slate-50 border-b border-slate-200 px-6 py-4 flex justify-between items-center">
                    <div>
                      <p className="font-bold text-lg text-slate-900">{selectedConversation.customerName}</p>
                  ...
                  <div className="border-t border-slate-200 bg-slate-50 p-4">
                    <p className="text-xs font-semibold text-slate-700 mb-3">Respuestas rápidas:</p>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {orders.length === 0 ? (
                ...
                <div className="space-y-4">
                  {orders.map((order) => (
                    <div key={order.id} className="border border-slate-200 rounded-lg p-4 bg-white hover:shadow-lg transition-all">
                      ...
                      <div className="mb-4 space-y-2">
                        ...
                        <div className="space-y-1">
                          {order.items.map((item, idx) => (
                            <p key={idx} className="text-sm text-slate-600 flex justify-between">
                      ...
                      <div className="mb-4 p-3 bg-slate-50 rounded-lg border border-slate-200">
                        <p className="text-xs font-semibold text-slate-600 mb-1">📍 Dirección de entrega:</p>
                        <p className="text-sm text-slate-800">{order.deliveryAddress}</p>
                      </div>
