...
const CreateSale = () => {
  ...
  return (
    <section className="space-y-6">
      <h2 className="text-2xl font-bold text-sf-text">📝 Registrar Nueva Venta</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
            <h3 className="font-semibold mb-3 text-sf-text">Agregar Producto</h3>
            <div className="space-y-3">
              <div>
                <label className="block text-sm font-medium mb-1 text-sf-text">Producto</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-sf-text">Cantidad</label>
                <input
                  type="number"
                  min="1"
                  value={quantity}
              ...
              <div className="overflow-x-auto">
                <table className="w-full divide-y divide-gray-200">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {cartItems.map((item) => (
                      <tr key={item.product_id} className="hover:bg-sf-light transition">
                        <td className="px-4 py-2 text-sm text-sf-text">{item.product_name}</td>
                        <td className="px-4 py-2 text-sm text-right text-sf-text">{formatPrice(item.price_cents)}</td>
                        <td className="px-4 py-2 text-sm text-right text-sf-text">{item.quantity}</td>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 h-fit">
          ...
          <div className="space-y-3 mb-6">
            <label className="block text-sm font-medium text-sf-text">Método de Pago</label>
            <select
              value={paymentMethod}
